    ...
    <div id="row">
		...
		?>
		  ...
		  <div class = "alert alert-info">
			...
			<div class = "alert alert-info">
			<label>DOCUMENTATION TEAM HEAD</label>
			<br/>
			<?php
			...
			<label>CREATIVE TEAM HEAD</label>
			<br />
			<?php
			...
			<div class = "alert alert-info" >
			<label>TECHNICAL TEAM HEAD</label>
			<br />
			<?php
				if(!$_SESSION['pio_id'])
					{
			...
			<div class = "alert alert-info">
			<label>ARRANGMENT TEAM HEAD</label>
			<br />
			<?php
			...
			<div class = "alert alert-success">
			<label>PRESENTATION TEAM HEAD</label>
			<br />
			<?php
				if(!$_SESSION['muse_id'])
					{
