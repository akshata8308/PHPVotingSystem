					...
					<div class="form-group">
						<label>Position</label>
							<select class = "form-control" name = "position">
								...
								<option>Documentation team head</option>
								<option>Creative head</option>
								<option>Technical head</option>
								<option>PPT team head</option>
								<option>Arrangment team</option>
								<option>Presentation team</option>
								<option>Overall team head</option>
							</select>
